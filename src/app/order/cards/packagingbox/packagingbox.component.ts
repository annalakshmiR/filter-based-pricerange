...
@Component({
  selector: 'app-packagingbox',
  templateUrl: './packagingbox.component.html',
  styleUrls: ['./packagingbox.component.css']
})
export class PackagingboxComponent implements OnInit {
  ...
  onSave(){
    ...
    this.route.navigateByUrl('/packagingrange')
  }
